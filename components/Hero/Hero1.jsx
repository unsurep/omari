    ...
    return (
        <section id="hero1" className="py-28 md:py-36 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/image/bg1.avif')"}}>
            <div className="grid grid-cols-1 md:flex items-center justify-between px-[1rem] lg:px-[3rem] relative">
                <div data-aos="fade-right" data-aos-duration="2000" className="font-inter flex flex-col gap-2 md:gap-5 items-center justify-center">
                    ...
                    <div className="pt-3 lg:flex lg:flex-col lg:gap-2">
                     <TextTransition springConfig={presets.slow} className="text-2xl md:text-4xl lg:text-5xl font-bold  ">{TEXTS[index % TEXTS.length]}
                     </TextTransition>
                     <h1 className="text-2xl md:text-4xl   lg:text-5xl font-bold">Drinking Water</h1>
                    </div>
                    ...
                    <div className="text-xs lg:flex items-center gap-8 hidden ">
                        ...
                        <button type="submit" className="relative inline-block text-lg group mt-5 lg:mt-0 shake cursor-pointer">
                            ...
                            <span className="relative text-sm">ABOUT US</span>
                            </span>
            ...
            <div className="lg:hidden gap-5 flex items-center justify-center pt-4 md:pt-12">
                <button className="py-1 border border-black px-4 bg-cyan-400 text-white rounded-full">About Us</button>
                <button className="py-1 px-4 bg-white border border-black rounded-full">Contact Us</button>
            </div>
        </section>
    )
};
