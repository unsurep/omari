...
const Hero2 = () => {
  return (
    <>
      <div className='px-[1rem] md:px-[3rem] py-12 text-zinc-900'>
       
        <div className='flex items-center justify-center gap-5 '>
          <Image src='/image/linebg.png' width={100} height={100} alt='image' className=''/>
          <h1 className='text-center text-cyan-600 text-3xl font-bold tracking-[5px] font-lato'>About Omari Premium</h1>
        </div>

        <div className='flex items-center py-8'>
          <div>
            <h1 className='text-4xl font-extrabold text-cyan-600 font-lato'>Our company was founded in 1770</h1>
          ...
          <div className='md:ml-auto shadow-cyan-400 shadow-lg'>
        ...
        <div className='py-12'>
          ...
          {/* whats inside */}
          <div className='flex items-center justify-between gap-10 font-lato relative'>
            {/* 1 */}
            <div>
              {/* Ca */}
              <div>
                ...
                <p className='pt-3'>Calcium in the range of 5–12 mg/dm³ <br /> plays a vital role in maintaining strong <br /> bones and teeth, supporting muscle <br /> function, and aiding nerve transmission. </p>
              </div>
              ...
              <div className='py-5'>
                ...
                <p className='pt-3'>Magnesium present at levels of 2–5 mg/dm³ <br /> is essential for maintaining healthy muscle <br /> and nerve function, supporting heart health, <br /> and aiding energy production in the body.</p>
              </div>
              ...
              <div>
                ...
                <p className='pt-3'>Sodium at levels of 20–25 mg/dm³ <br /> plays a key role in maintaining fluid <br /> balance, supporting nerve function, <br /> and regulating blood pressure in the body.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <Image src='/image/bottled.png' width={120} height={120} alt='image' className='absolute top-[7rem] right-[37rem]'/>
            ...
            <div>
              ...
              <div>
                ...
                <p className='pt-3'>Chlorine at approximately 46 mg/dm³ <br /> is crucial for ensuring safe and clean <br /> drinking water by effectively eliminating <br /> harmful bacteria, viruses, and other pathogens. </p>
              </div>
              ...
              <div className='py-5'>
                ...
                <p className='pt-3'>The pH level of drinking water is typically between <br /> 6.8 and 7.3, plays a vital role in maintaining its taste, <br /> safety  and overall balance. </p>
              </div>
              ...
              <div>
                ...
                <p className='pt-3'>Mineralization at a balanced level of 90–140 mg/dm³ <br /> reflects the total amount of essential minerals like <br /> calcium, magnesium, and sodium present in drinking <br /> water.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='flex items-center px-[1rem] md:px-[3rem] justify-between text-white bg-no-repeat bg-cover h-[50vh]' style={{ backgroundImage: "url('/image/wave.svg')"}}>
          ...
          <div>
            ...
            <p className='text-2xl font-bold pt-10'>Healthy Composition</p>
          </div>
